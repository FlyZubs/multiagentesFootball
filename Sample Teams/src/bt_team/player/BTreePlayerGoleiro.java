...
public class BTreePlayerGoleiro extends Thread {
	...
	BTNode<BTreePlayerGoleiro> btree;
	
	
	public BTreePlayerGoleiro(PlayerCommander player, Vector2D home) {
		commander = player;
		homePosition = home;
	...
	private BTNode<BTreePlayerGoleiro> buildTree() {
		Selector<BTreePlayerGoleiro> raiz = new Selector<BTreePlayerGoleiro>("RAIZ");
		
		Sequence<BTreePlayerGoleiro> goleiroTree = new Sequence<BTreePlayerGoleiro>("Chuta a bola pra longe");
